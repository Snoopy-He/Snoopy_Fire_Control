...
function Target_Update(parameter)
    ...
    elseif parameter.Target_Type == "Monster" and parameter.Location.Monster_TarFlag then
        ...
        parameter.Gimbal.Yaw_TarAng = parameter.Gimbal.Yaw_Offset
...
function Track_Calc(parameter)   --弹道计算
    ...
    parameter.Gimbal.Yaw_TarAng = math.deg(math.atan_in_circle(parameter.Location.Target.X - parameter.Location.Cannon.X, parameter.Location.Target.Z - parameter.Location.Cannon.Z)) + parameter.Gimbal.Yaw_O
