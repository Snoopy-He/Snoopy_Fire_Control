...
function Track_Calc(parameter)   --弹道计算
    ...
    parameter.Location.Target.Flying_Time = Flying_Time_Calc(parameter.Gimbal.Pitch_TarAng, parameter.Location.Target.Distance_2D,parameter)
end

function Flying_Time_Calc(pitch,distance,parameter)
    if parameter.local n,m,d,T,k,l = 6,40,0.01,0.05,0.05,6 == "AutoCannon" then
