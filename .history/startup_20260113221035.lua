...
:"..parameter.Location.Monster_Targets[1].Z)        parameter.Location.Target = LinearPredictor_Calc(parameter.Location.Monster_Targets[1],parameter.Location.Flying_Time)
        Track_Calc(parameter)
    end
    local i = 0
    for i = 1,3 do
...
function Target_Update(parameter)
    ...
    elseif parameter.Target_Type == "Monster" and parameter.Location.Monster_TarFlag then
        ...
        parameter.Gimbal.Yaw_TarAng = 90
