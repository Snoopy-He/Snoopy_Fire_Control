...
function Track_Calc(parameter)   --弹道计算
    local n,m,v,d,T,g,l = 6,40,160,0.01,0.05,0.05,6
...
function Flying_Time_Calc(pitch,distance,parameter)
    ...
    local result = -math.log(1-(distance-l*math.cos(pitch))*d/math.cos(pitch))/d
    return result
end
...
while true do
    ...
    print("time:"Parameters.Location.Flying_Time)
