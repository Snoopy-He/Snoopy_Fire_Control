...
function LinearPredictor_Calc(target_pos, flying_time,cannon_pos)
    ...
    return {
        X = target_pos.X + target_vx * flying_time * (0.8 +(target_pos.Y-cannon_pos.Y)/50),
        Y = target_pos.Y + target_vy * flying_time * (0.8 +(target_pos.Y-cannon_pos.Y)/50),
        Z = target_pos.Z + target_vz * flying_time * (0.8 +(target_pos.Y-cannon_pos.Y)/50),
    }
end
