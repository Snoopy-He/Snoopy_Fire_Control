...
function Predict_Calc(target_pos, flying_time)
    ...
    return {
        X = target_pos.X + (target_vx + target_vpx)/2 * flying_time + target_ax/2 * flying_time * flying_time,
        Y = target_pos.Y + (target_vy + target_vpy)/2 * flying_time + target_ay/2 * flying_time * flying_time,
        Z = target_pos.Z + (target_vz + target_vpz)/2 * flying_time + target_az/2 * flying_time * flying_time
    }
end
