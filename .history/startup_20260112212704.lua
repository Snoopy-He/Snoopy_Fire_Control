...
function Motor_Calc(parameter)
    ...
    parameter.Gimbal.Yaw_TarAng = math.nan_Check(parameter.Gimbal.Yaw_TarAng,parameter.Gimbal.Yaw_TarAng)
    parameter.Gimbal.Pitch_TarAng = math.nan_Check(parameter.Gimbal.Yaw_TarAng,last_pitch)
