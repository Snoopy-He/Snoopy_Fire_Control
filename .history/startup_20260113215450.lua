...
function Target_Update(parameter)
    ...
    if parameter.Location.Monster_Targets ~= nil and parameter.Target_Type == "Monster" then
        ...
        print("x1:"..math.floor(parameter.Location.Monster_Targets[1].X).."x2:"..math.floor(parameter.Location.Monster_Targets[2].X).."x3:"..math.floor(parameter.Location.Monster_Targets[1].X)..)
        Predictor_Calc(parameter)
    end
