...
function Predict_Calc(target_pos, flying_time)
    ...
    return {
        X = target_pos.X + (target_vx + target_vpx)/2 * flying_time * 1.3 + target_ax/2 * flying_time * flying_time/20,
        Y = target_pos.Y + (target_vy + target_vpy)/2 * flying_time * 1.3 + target_ay/2 * flying_time * flying_time/20,
        Z = target_pos.Z + (target_vz + target_vpz)/2 * flying_time * 1.3 + target_az/2 * flying_time * flying_time/20
    }
end
