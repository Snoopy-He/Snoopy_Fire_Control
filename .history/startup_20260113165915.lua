...
function Track_Calc(parameter)   --弹道计算
    ...
    print("yaw:"..math.deg(math.atan_in_circle(parameter.Location.Target.X - parameter.Location.Cannon.X, parameter.Location.Target.Z - parameter.Location.Cannon.Z))
