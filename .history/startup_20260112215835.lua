...
function Track_Calc(parameter)   --弹道计算
    ...
    parameter.Location.Target.Distance_3D = Distance_3D_Calc(x1, y1, z1, x2, y2, z2),
    parameter.Location.Target.Distance_2D = w
    parameter.Location.Target.Flying_Time = Flying_Time_Calc(parameter.Gimbal.Pitch_TarAng, Distance_2D_Calc(x1, z1, x2, z2))
    return {
