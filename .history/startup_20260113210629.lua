...
function Track_Calc(parameter)   --弹道计算
    ...
    parameter.Location.Target.Flying_Time = Flying_Time_Calc(math.min(pitch1, pitch2), w,parameter)
    --print("time:"..parameter.Location.Flying_Time)
    print("time:"..Flying_Time_Calc(math.min(pitch1, pitch2), w,parameter))
end
