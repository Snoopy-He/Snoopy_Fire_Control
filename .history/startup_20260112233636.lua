...
function Track_Calc(parameter)   --弹道计算
    ...
    print("n"..parameter.AutoCannon.n.."m"..parameter.AutoCannon.m.."d"..parameter.AutoCannon.d.."T"..parameter.AutoCannon.T.."k"..parameter.AutoCannon.k.."l"..parameter.AutoCannon.T..)
