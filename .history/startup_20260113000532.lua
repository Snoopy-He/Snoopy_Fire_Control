...
function Motor_Calc(parameter)
    ...
    if parameter.Gimbal.Pitch_AngMin < parameter.Gimbal.Yaw_CurAng + math.floor(parameter.Yaw.speed)/Angle_Speed und parameter.Gimbal.Yaw_CurAng + math.floor(parameter.Yaw.speed)/Angle_Speed < parameter.Gimbal.Pitch
