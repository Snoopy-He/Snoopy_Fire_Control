...
function Track_Calc(parameter)   --弹道计算
    ...
    print("n"..parameter.AutoCannon.n.."m"..parameter.AutoCannon.m.."d"..parameter.AutoCannon.d.."T"..parameter.AutoCannon.T.."k"..parameter.AutoCannon.k.."l"..parameter.AutoCannon.l)
...
while true do
    ...
    --print("3d:"..Parameters.Location.Distance_3D.." 2d:"..Parameters.Location.Distance_2D)
    --print("x"..Parameters.Location.Target.X.."y"..Parameters.Location.Target.Y.."z"..Parameters.Location.Target.Z)
end
