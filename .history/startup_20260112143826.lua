...
function Targets_Filter(targets)
...
function Target_Update(cannon_pos,player_targetsdist_min,dist_max)
    ...
    Player_Targets = Targets_Filter(Player_Targets)
    Monster_Targets = Targets_Filter(Monster_Targets)
    return {
        X = tx,
        Y = ty,
        Z = tz,
