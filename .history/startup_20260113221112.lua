...
function Target_Update(parameter)
    ...
    parameter.Location.Distance_3D = 0tion.Cannon.X, parameter.Location.Cannon.Y, parameter.Location.Cannon.Z, parameter.Location.Target.X, parameter.Location.Target.Y, parameter.Location.Target.Z)
