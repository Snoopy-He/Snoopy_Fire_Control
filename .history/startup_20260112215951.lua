...
function Track_Calc(parameter)   --弹道计算
    ...
    parameter.Location.Target.Distance_3D = Distance_3D_Calc(parameter.Location.Cannon.X, parameter.Location.Cannon.Y, parameter.Location.Cannon.X, parameter.Location.Target.X, parameter.Location.Target.Y, parameter.Location.Target.Z),
