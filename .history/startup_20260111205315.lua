...
function LinearPredictor_Calc(target_pos, flying_time)
    ...
    print("predit:"..target_vx * flying_time * (0.6 + 1/total_v / 10).."total_v:"..total_v)
    return {
        X = target_pos.X + target_vx * flying_time * (0.6 + 1/total_v / 10),
        Y = target_pos.Y + target_vy * flying_time * (0.6 + 1/total_v / 10),
        Z = target_pos.Z + target_vz * flying_time * (0.6 + 1/total_v / 10),
    }
end
