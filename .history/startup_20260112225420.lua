...
function Predictor_Calc(parameter)
    if parameter.Target_Type == "Player" then
        parameter.Location.Target = LinearPredictor_Calc(parameter.player_targets[1],parameter.Location.Flying_Time)
        ...
        parameter.Location.Target = LinearPredictor_Calc(parameter.monster_targets[1],parameter.Location.Flying_Time)
        Track_Calc(parameter)
        parameter.Location.Target = LinearPredictor_Calc(parameter.Location.Target,parameter.Location.Flying_Time)
        Tack_Calc(parameter)
    end
...
function Motor_Calc(parameter)
    ...
    parameter.Gimbal.Pitch_TarAng = math.clamp(parameter.Gimbal.Pitch_TarAng, parameter.Gimbal.Pitch_AngMin,parameter.Gimbal.Pitch_AngMin)
