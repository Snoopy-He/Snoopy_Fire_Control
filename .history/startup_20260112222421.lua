...
function Target_Update(parameter)
    ...
    for k, v in pairs(players) do
        parameter.Location.player_targets[i] = Player_Target_Update(v,parameter.Location.Cannon,parameter.Location.Distance_Min,parameter.Location.Distance_Min,parameter.Location.player_targets)
        i=i+1
    end
    i = 1
    for k, v in pairs(monsters) do
        parameter.Location.monster_targets[i] = Monster_Target_Update(v,parameter.Location.Cannon,parameter.Location.Distance_Min,dist_max,parameter.Location.monster_targets)
        i = i+1
    end
