...
function Target_Update(parameter)
    ...
    for k, v in pairs(players) do
        parameter.Location.player_targets[i] = Player_Target_Update(v,parameter.Location.Cannon,parameter.Location.Distance_Min,dist_max,parameter.Location.player_targets)
        i=i+1
    end
    i = 1
