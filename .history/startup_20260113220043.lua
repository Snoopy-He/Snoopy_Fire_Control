...
function Target_Pos_Update(parameter)
    ...
    if i = 1 then
        parameter.Location.Player_Targets[1].X = 0
        parameter.Location.Player_Targets[1].Y = 0
        parameter.Location.Player_Targets[1].Z = 0
    end
    i = 1
    ...
    if i = 1 then
        parameter.Location.Monster_Targets[1].X = 0
        parameter.Location.Monster_Targets[1].Y = 0
        parameter.Location.Monster_Targets[1].Z = 0
    end
end
...
function Target_Update(parameter)
    ...
    if parameter.Target_Type == "Monster" then
        ...
        print("x1:"..math.floor(parameter.Location.Monster_Targets[1].X).."x2:"..math.floor(parameter.Location.Monster_Targets[2].X).."x3:"..math.floor(parameter.Location.Monster_Targets[3].X))
        Predictor_Calc(parameter)
    end
...
function Track_Calc(parameter)   --弹道计算
    local v,d,g,l = 160,0.01,0.05,6
    if parameter.Cannon_Type == "AutoCannon" then
        v = parameter.AutoCannon.v/20
        d = parameter.AutoCannon.d
        g = parameter.AutoCannon.g
        l = parameter.AutoCannon.l
    else
        v = parameter.BigCannon.v/20
        d = parameter.BigCannon.d
        g = parameter.BigCannon.g
